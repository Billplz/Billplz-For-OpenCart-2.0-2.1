...
class ControllerPaymentBillplz extends Controller
{
    public function index()
    {
        ...
        $_SESSION['redirect_url'] = $this->url->link('payment/billplz/return_ipn', '', true);
        $_SESSION['callback_url'] = $this->url->link('payment/billplz/callback_ipn', '', true);
    ...
    public function proceed()
    {
        ...
        */
        ...
        if (empty($billplz->getURL())) {
            echo '<pre>'.print_r($billplz->getErrorMessage(), true).'</pre>';
        }
