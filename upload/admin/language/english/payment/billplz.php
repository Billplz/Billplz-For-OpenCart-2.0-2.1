...
$_['text_billplz']	     			= '<a onclick="window.open(\'http://billplz.com/join/lz7pmrxa45tiihvqdydxqq\');" style="text-decoration:none;"><img src="view/image/payment/billplz-logo.jpg" alt="Billplz Online Payment Gateway" title="Billplz Malaysia Online Payment Gateway" style="border: 0px solid #EEEEEE;" height=25 width=94/></a>';
